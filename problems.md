...
#### 116. Populating Next Right Pointers in Each Node (24/1)
...
#### 117. Populating Next Right Pointers in Each Node II (26/1)



`Hint: bfs, and use a dummy and nxt node`
...
#### 2641. Cousins in BInary Tree II (27/1)



`Hint: value = next_level_sum - children_sum`
